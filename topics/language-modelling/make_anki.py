...
deck = genanki.Deck(2059400112, "Language Modelling (from the explainer)")
rng = random.Random(7)
...
out = Path(__file__).resolve().parents[2] / "docs" / "language-modelling.apkg"
