...
<span class="topic-title"><a href="index.html"><span class="topic-back">&larr;</span> Diffusion Language Models</a></span>
<nav class="topicbar-nav"><a href="2026-08-01-diffusion-language-models.html">explainer</a>
<a href="2026-08-02-dllm-cheatsheet.html">cheat sheet</a>
<a href="https://github.com/raghuramshankar/learning-with-llms/tree/main/tutorials/masked-diffusion">tutorials</a></nav>
</div></div>
<div class="wrap">
<h1>Review deck: diffusion language models</h1>
<p class="sub">Spaced repetition over the explainer's __NQ__ questions (Leitner boxes:
...
import datetime
html = html.replace("__NQ__", str(len(bank)))
