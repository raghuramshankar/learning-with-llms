...
<style>
:root {
  --bg:#fbfbfd; --fg:#171b22; --muted:#5b6472; --line:#e4e7ee;
  --accent:#2458c5; --accent-soft:#e9effc; --ok:#1e7e46; --ok-soft:#e8f5ec;
  --card:#ffffff; --hero-glow:rgba(36,88,197,0.09);
}
@media (prefers-color-scheme: dark) { :root {
  --bg:#12151a; --fg:#e7eaef; --muted:#98a1af; --line:#2a303a;
  --accent:#7aa5f0; --accent-soft:#1c2841; --ok:#62c088; --ok-soft:#17301f;
  --card:#181c23; --hero-glow:rgba(122,165,240,0.08);
} }
...
h2 { font-family:Georgia, 'Times New Roman', serif; font-weight:600;
...
.topic h3 { font-family:Georgia, serif; font-size:1.35rem; margin:0; }
